  ...
  context "Resource" do
    ...
    context "ParameterGroupRedis" do
      ...
      it "to have property Properties" do
          expect(resource["Properties"]["Properties"]).to eq({"cluster-enabled"=>"no"})
      end
    ...
    context "ReplicationGroupRedis" do
      ...
      it "to have property AutomaticFailoverEnabled" do
          expect(resource["Properties"]["AutomaticFailoverEnabled"]).to eq(false)
      end
    ...
    context "HostRecordRedis" do
      ...
      it "to have property ResourceRecords" do
          expect(resource["Properties"]["ResourceRecords"]).to eq([{"Fn::GetAtt"=>["ReplicationGroupRedis", "PrimaryEndPoint.Address"]}])
      end
